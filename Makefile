...
GemmDriver: GemmDriver.o blis_interface.o
	/opt/rocm/hip/bin/hipcc -g -o GemmDriver GemmDriver.o blis_interface.o  $(BLIS) $(FLAME)  $(ROCBLASLIB) $(BOOST)
else
GemmDriver: GemmDriver.o blis_interface.o
	/opt/rocm/hip/bin/hipcc -o GemmDriver GemmDriver.o blis_interface.o  $(BLIS) $(FLAME)  $(ROCBLASLIB) $(BOOST)
endif
else
ifeq ($(DEBUG),1)
GemmDriver: GemmDriver.o
	/opt/rocm/hip/bin/hipcc -g -o GemmDriver GemmDriver.o $(ROCBLASLIB) $(BOOST)
else
GemmDriver: GemmDriver.o
	/opt/rocm/hip/bin/hipcc -o GemmDriver GemmDriver.o $(ROCBLASLIB) $(BOOST)
endif
endif
